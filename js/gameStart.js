const gameStart = {
    ...
    create: function () {
        ...
        function collisionCallback (obj1, obj2) {
            ...
            {
                obj1.setVelocityY(obj1.body.velocity.y*0.3);
                obj1.setVelocityX(obj1.body.velocity.x*0.3);
                obj2.setVelocityY(obj2.body.velocity.y*1.3);
                obj2.setVelocityX(obj2.body.velocity.x*1.3);
            }
            else
            {
                obj1.setVelocityY(obj1.body.velocity.y*1.3);
                obj1.setVelocityX(obj1.body.velocity.x*1.3);
                obj2.setVelocityY(obj2.body.velocity.y*0.3);
                obj2.setVelocityX(obj2.body.velocity.x*0.3);
            }
